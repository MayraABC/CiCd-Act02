...
class TestUtil(unittest.TestCase):
    ...
    def test_invalid_convert_to_number_correct_param(self):
        ...
        self.assertEqual(0, util.invalid_convert_to_number("0"))
        self.assertEqual(-1, util.invalid_convert_to_number("-1"))
        self.assertAlmostEqual(4.0, util.invalid_convert_to_number("4.0"), delta=0.0000001)
        self.assertAlmostEqual(-1.0, util.invalid_convert_to_number("-1.0"), delta=0.0000001)
